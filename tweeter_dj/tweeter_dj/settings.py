"""
Django settings for tweeter_dj project.
...
SECRET_KEY = 'django-insecure-q%usj+5hcop4)e(p-p7a3yz!#7xn+hp7v!oilwe=slti*@(9u='
...
WSGI_APPLICATION = 'tweeter_dj.wsgi.application'
...
REGITRATION_OPEN = True  # Set to False to close registration
